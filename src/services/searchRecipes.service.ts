...
import {InformationInterface, RecipesInterface} from "../interfaces";
...
const searchRecipesService ={
    ...
    getRecipeByID : (id:number):AxiosRes<InformationInterface> => axiosInstance.get(`/${id}${urls.information}${urls.auth.apiKey}`)
}
